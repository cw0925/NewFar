...
+ (UIImage *)SG_generateWithLogoQRCodeData:(NSString *)data logoImageName:(NSString *)logoImageName logoScaleToSuperView:(CGFloat)logoScaleToSuperView {
    ...
    NSURL *url = [NSURL URLWithString:icon_imageName];
    //UIImage *icon_image = [UIImage imageWithData:[NSData dataWithContentsOfURL:url]];
    NSData *imgData = [NSData  dataWithContentsOfURL:url];
    UIImage *icon_image = [[UIImage alloc]initWithData:imgData];
    //
