...
-(UILabel *)textLabel{
    ...
    _textLabel.font = [UIFont systemFontWithSize:14];
...
- (void)initDatas
{
    ...
    //净收款额
    _textLabel.bounds = CGRectMake(0, 0, self.radius*1.6-30, 50);
    _textLabel.center = CGPointMake(self.width/2+30, self.height/2);
    //总和
//    _valueLabel.bounds = CGRectMake(0, 0, self.radius*1.6, 25);
